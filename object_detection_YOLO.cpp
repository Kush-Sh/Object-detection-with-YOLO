...
void detectObjects2()
{
    ...
    cv::Mat img = cv::imread("images/yolo.jpg");
    ...
    for (auto it = bBoxes.begin(); it != bBoxes.end(); ++it)
    {
        ...
        cv::rectangle(visImg, cv::Point(left, top), cv::Point(left + width, top + height), cv::Scalar(255, 255, 255), 0.5);
